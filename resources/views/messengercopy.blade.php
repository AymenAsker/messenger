                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto">
                                                    <a href="#" class="avatar ">
                                                        <img class="avatar-img" src="avatar_url" alt="">
                                                    </a>
                                                </div>
                    ...
                    <div class="hide-scrollbar">
                        ...
                        <div class="container py-8">
                            ...
                            <div class="card-list">
                                    ...
                                    <!-- Card -->
                                    <a href="chatid" class="card border-0 text-reset">
                                        <div class="card-body">
                                            <div class="row gx-5">
                                                <div class="col-auto">
                                                    <div class="avatar avatar-online">
                                                        <span
                                                            class="avatar-text">name</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <span
                                                            class="text-muted extra-small ms-2">created_at</span>
                                                    </div>
